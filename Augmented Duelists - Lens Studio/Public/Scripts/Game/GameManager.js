...
//script.Player1.api.SetMonster(script.MonsterInfo[2]);
//script.Player1.api.SetMonster(script.MonsterInfo[1]);
//script.Player1.api.SetMonster(script.MonsterInfo[2]);
//script.Player1.api.SetMonster(script.MonsterInfo[1]);
//print(script.Player1.api.GetHealth());
//print(script.Player1.api.GetMonsterName());
////print(script.Player1.HasMonster);
